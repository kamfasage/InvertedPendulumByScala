...
/**
 * This is the runge Kutta approximation class. this class implementns the runge
 * kutta approximation of a equation. The equation needs to be in the right
 * format.
 *
 * @author raphi
 *
 */
class RungeKutta(var ode: DiffEq) extends DiffSolver {
   ...
   * @param stepSize what time needs to be evaluated (in seconds)
   */
